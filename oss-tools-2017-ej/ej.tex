...
\begin{abstract}
  ...
  % Problema
  However, the participation process is more than just giving your opinion, it is
  ...
  to a problem. But the social networks and the recommendation systems, in their
  ...
  % Soluções propostas
  In this article we present Pushing Together, an open source platform
  for collaborative participation with the aim of breaking the bubbles that
  freezes people in their mindsets. Using gamification concepts and clustering
  algorithms, the tool was thought to identify diferent groups of opinion
  in a conversation and give power to some special actors to interact with other groups.
  % Frase de impacto
...
\textbf{Palavras-chave:} social particpation, bubbles of opinion, democracy, gamification
\end{abstract}
