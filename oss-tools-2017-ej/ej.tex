...
\institute{Faculdade do Gama -- Universidade de Brasília (UnB)\\
  ...
  \and
          ...
          São Paulo/SP -- Brazil\\
  \email{\{henrique,ricardo\}@cidadedemocratica.org.br}
}
...
\label{sec:pushingtogether}
 ...
 \end{figure}
  ...
  Making an analysis about the users opinions, we initially
  identify three profiles (Figure \ref{fig:userprofiles}) that are considered the potential receptors for the ``Push''
  and some effects that can take place. With this initial profiles shaping we intend to get a different interaction level
  between the multiple opinions in a group of discussion of a
 ...
 \end{figure}
  ...
  written in React Native\footnote{\url{facebook.github.io/react-native/}},
  and a NodeJS\footnote{\url{nodejs.org/en/}} server. The server module is responsible
  for managing users, the ``Push'' resources in the gamification, and to make
