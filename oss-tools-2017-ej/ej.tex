...
one click effort. This, including in another experiences (INCLUIR REF
ARENANETMUNDIAL), has shown to be a great option to break the barriers for
engagement and for opening more space to discussions.
...
application, written in React Native \cite{reactNativeSite}, and a
NodeJS \cite{nodeJSSite} server. The server module is responsible
