...
\begin{block}{Facing the bubbles}
  \begin{itemize}
    ...
    \item Civic tech platforms with threaded arquiteture are getting restricted to
    the activist profile not engaging many people.

    \item Popular social media recommendation algorithms are black boxes based on
    a publicity oriented business model.
