...
\begin{block}{What is Empujando Juntos}
  ...
  \begin{itemize}
    ...
    increase communication between people in a online conversation.
...
\begin{block}{Why Empurrando Juntos?}
  \begin{itemize}
    \item Encourages the interaction between different groups of opinion.

    \item Brings new resources for online discussions using gamification concepts.
...
\begin{block}{Empujando Juntos Features}
  \begin{itemize}
    ...
    this ability are able to send direct messages and create events in the platform.
    ...
    \item Consultation owners have their content highlighted and can also open
